 ...
 * @package Woo_AI
 *
 * @var string $woo_ai_chat_title         The chat widget title.
 * @var string $woo_ai_widget_title_color Color for chat widget title.
...
<form method="post" action="">
	...
	<table class="form-table">
		...
		<tr>
			...
			<td>
				<?php $this->output_text_field( 'woo_ai_assistant_name' ); ?>
		...
		<tr>
			...
			<td>
				<?php $this->output_text_field( 'woo_ai_chat_title' ); ?>
        ...
        <tr>
            ...
            <td>
                <input type="color" name="woo_ai_widget_title_color"
                       value="<?php echo esc_attr( $woo_ai_widget_title_color ); ?>"/>
...
<div class="woo-ai-preview"
	...
	<div id="woo-ai-preview-widget"
	     style="position: relative; width: 300px; height: 400px; border: 1px solid #ccc; border-radius: 12px; overflow: hidden; background: var(--woo-ai-background, #ffffff);">
...
<script>
    ...
    function updatePreview() {
        const preview = document.getElementById('woo-ai-preview-widget');
        if (!preview) return;
        ...
        preview.style.setProperty('--woo-ai-primary-gradient-start', primaryGradientStart);
        preview.style.setProperty('--woo-ai-primary-gradient-end', primaryGradientEnd);
        preview.style.setProperty('--woo-ai-primary-gradient-coloe', primaryGradientColor);
        preview.style.setProperty('--woo-ai-primary-color', primaryColor);
        preview.style.setProperty('--woo-ai-primary-hover', primaryHover);
        preview.style.setProperty('--woo-ai-secondary-color', secondaryColor);
        preview.style.setProperty('--woo-ai-text-primary', textPrimary);
        preview.style.setProperty('--woo-ai-text-secondary', textSecondary);
        preview.style.setProperty('--woo-ai-text-light', textLight);
        preview.style.setProperty('--woo-ai-background', background);
        preview.style.setProperty('--woo-ai-background-light', backgroundLight);
        preview.style.setProperty('--woo-ai-border-color', borderColor);
        preview.style.setProperty('--woo-ai-border-light', borderLight);
                ...
                <div style="flex: 1; padding: 16px; background: ${background}; overflow-y: auto;">
                    <div style="margin-bottom: 12px;">
                        <div style="background: ${backgroundLight}; padding: 8px 12px; border-radius: 18px; display: inline-block; max-width: 80%;">
                            <p style="margin: 0; color: ${textPrimary}; font-size: 14px;">Hello! How can I help you today?</p>
                        </div>
                    </div>
